...
public class KeyboardService {
    ...
    public void setKeyboardToMessage(SendMessage sendMessage, List<String> buttons) {
        ...
        fill(buttons, row, applicationProperties.getNumberOfButtonsInRowInlineKeyboards(), keyboardRows, (i, index) -> InlineKeyboardButton.builder()
                .text(buttons.get(index))
                .callbackData(buttons.get(index))
                .build());
